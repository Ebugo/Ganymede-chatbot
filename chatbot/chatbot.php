        ...
        if ($train === 0) {
            ...
            if (preg_match('/\baboutbout\b/',$input)) {
                ...
                if ($row_cnt > 0) {
                    ...
                    return "I am sorry, this question wasn't found,Please ENTER TRAIN:QUESTION#ANSWER#password to make me smarter";
            }
        }
    }
}
...
<div class="d-flex justify-content-center align-items-center mt-5 pt-5 pl-5">
    <div class="d-block w-50 mt-5 ml-10">
        <div class="w-50" id="header">
            <h2 class="text-center my-0 py-0" style="margin-bottom: 10px">Chat with Ganymede</h2>
            <p class="text-center text-lighte" style="font-size: 15px; opacity: 0.7" id="greet">Hi, Welcome to team Ganymede's chatbot arena!! Type help to get information on how to use me</p>
        </div>
